import type {
  FamilyPsychologySection,
  TransmissionNode,
  CommunicationExample,
  PatternIndicator,
} from './family-psychology.schema';
...
export const PSYCHOLOGY_SECTIONS: FamilyPsychologySection[] = [
  ...
  },
  {
    ...
    contentKeys: ['familyPsychology.sections.recognition.content.0'],
    type: 'patterns',
  },
  {
    id: 'observer',
  ...
  },
  {
    ...
    contentKeys: ['familyPsychology.sections.liberation.content.0'],
    type: 'liberation',
  },
];
...
export const LIBERATION_STEPS = [
  'familyPsychology.sections.liberation.steps.0',
  'familyPsychology.sections.liberation.steps.1',
  'familyPsychology.sections.liberation.steps.2',
  'familyPsychology.sections.liberation.steps.3',
];
